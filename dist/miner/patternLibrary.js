 ...
 */
export function generatePatternLibraryFile(patternSet, boardSize, starsPerRow, starsPerColumn, outputDir) {
 ...
 */
export function generateAllPatternLibraryFiles(patternSets, boardSize, starsPerRow, starsPerColumn, outputDir) {
    // Ensure output directory exists
    if (!existsSync(outputDir)) {
        mkdirSync(outputDir, { recursive: true });
    }
    for (const patternSet of patternSets) {
        generatePatternLibraryFile(patternSet, boardSize, starsPerRow, starsPerColumn, outputDir);
    }
}
