 ...
 */
export async function verifyPattern(state, window, expectedDeductions) {
    ...
    const forceStarCells = [];
    const forceEmptyCells = [];
 ...
 */
export function arePatternsEquivalent(p1, p2) {
...
//# sourceMappingURL=patternVerifier.js.map